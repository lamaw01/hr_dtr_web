                              ...
                              child: SizedBox(
                                ...
                                child: employee.isSearching
                                    ? ListView.separated(
                                        ...
                                        itemCount:
                                            employee.searchEmployeeList.length,
                                        itemBuilder: ((context, index) {
                                          return CheckboxListTile(
                                            title: Text(employee.fullName(
                                                employee.searchEmployeeList[
                                                    index])),
                                            value: employee
                                                .searchEmployeeList[index]
                                                .isSelected,
